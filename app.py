...
tabs[0].header("Python crash course part 1")

tabs[0].subheader("Slides")

tabs[0].markdown("[![Google Drive](https://img.shields.io/badge/Google%20Drive-4285F4?style=for-the-badge&logo=googledrive&logoColor=white)](https://raw.githubusercontent.com/ZaidDeAnda/CdeC2026-mty/main/slides/Crash%20Course%20Python.pptx)")

tabs[0].subheader("Notebook")
...
tabs[1].header("Intro to ML")

tabs[1].subheader("Slides")

tabs[1].markdown("[![Google Drive](https://img.shields.io/badge/Google%20Drive-4285F4?style=for-the-badge&logo=googledrive&logoColor=white)](https://raw.githubusercontent.com/ZaidDeAnda/CdeC2026-mty/main/slides/ML-Presentation.pptx)")

tabs[1].subheader("Notebook")
...
tabs[2].markdown("[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/ZaidDeAnda/CdeC2026-mty/blob/main/notebooks/Redes_Neuronales_2.ipynb)")
